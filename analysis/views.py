...
class AnalysisView(View):
     ...
     def post(self, request, interview_id):
        ...
        if Analysis.objects.filter(interview=interview).exists():
            interview = Interview.objects.get(id=interview_id)
            analysis = Analysis.objects.get(interview=interview)
            emotions_total = eval(analysis.facial_expression)
            vs = ast.literal_eval(analysis.sentiment_score)
