...
urlpatterns = [
    ...
    path('passwordchange/', auth_views.PasswordChangeView.as_view(template_name='users/password_change.html', form_class=ChangePasswordForm,success_url='/users/passwordchange/done/'), name='passwordchange'),
