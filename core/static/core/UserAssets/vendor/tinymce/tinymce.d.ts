...
declare type Bookmark = StringPathBookmark | RangeBookmark | IdBookmark | userindexBookmark | PathBookmark;
...
interface DOMUtils {
    ...
    createRng: () => Range;
    nodeuserindex: (node: Node, normalized?: boolean) => number;
    split: {
